	...
	<div class="navbar navbar-default navbar-fixed-top bs-docs-nav" role="banner">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo U('Home/Index/index');?>"><img src="./Public/Home/images/logo.jpg" id="logo"/></a>
			</div>
			<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
				<ul class="nav navbar-nav">
					<li><a href="<?php echo U('/Home/Index/index');?>" class="anchorLink">首页</a></li>
					<li><a href="<?php echo U('');?>" class="anchorLink">资讯</a></li>
					...
					<ul class="rightNavUl">
						...
						<?php else: ?><span class="rightNav"><?php echo ($username); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U('/Home/Center/articleList');?>" style="color:#fff;">进入个人中心</a></span><?php endif; ?>
					</ul>
		...
		<div class="container">
			<div class="col-md-3">
				<ul class="userUl">
					...
					<a href="javascript:void(0);"><li class="userLi">个人资料</li></a>
					<a href="<?php echo U('/Home/Center/uploadArticle');?>"><li class="userLi">上传文章</li></a>
					<a href="<?php echo U('/Home/Center/articleList');?>"><li class="userLi">文章记录</li></a>
				</ul>
			</div>
			<div class="col-md-9">
				<div class="userDiv">
