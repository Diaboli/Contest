...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_9412__=($page['pages']-9);$__FOR_END_9412__=($page['pages']+1);for($i=$__FOR_START_9412__;$i < $__FOR_END_9412__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_4013__=1;$__FOR_END_4013__=11;for($i=$__FOR_START_4013__;$i < $__FOR_END_4013__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_4834__=($page['pageNumber']-4);$__FOR_END_4834__=($page['pageNumber']+5);for($i=$__FOR_START_4834__;$i < $__FOR_END_4834__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_5747__=1;$__FOR_END_5747__=$page['pages'] + 1;for($i=$__FOR_START_5747__;$i < $__FOR_END_5747__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
