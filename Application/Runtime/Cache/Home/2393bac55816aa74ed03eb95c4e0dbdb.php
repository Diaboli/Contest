...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_12056__=($page['pages']-9);$__FOR_END_12056__=($page['pages']+1);for($i=$__FOR_START_12056__;$i < $__FOR_END_12056__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_3441__=1;$__FOR_END_3441__=11;for($i=$__FOR_START_3441__;$i < $__FOR_END_3441__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_22358__=($page['pageNumber']-4);$__FOR_END_22358__=($page['pageNumber']+5);for($i=$__FOR_START_22358__;$i < $__FOR_END_22358__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_5079__=1;$__FOR_END_5079__=$page['pages'] + 1;for($i=$__FOR_START_5079__;$i < $__FOR_END_5079__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
