...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_1408__=($page['pages']-9);$__FOR_END_1408__=($page['pages']+1);for($i=$__FOR_START_1408__;$i < $__FOR_END_1408__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_1977__=1;$__FOR_END_1977__=11;for($i=$__FOR_START_1977__;$i < $__FOR_END_1977__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_22526__=($page['pageNumber']-4);$__FOR_END_22526__=($page['pageNumber']+5);for($i=$__FOR_START_22526__;$i < $__FOR_END_22526__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_2911__=1;$__FOR_END_2911__=$page['pages'] + 1;for($i=$__FOR_START_2911__;$i < $__FOR_END_2911__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
