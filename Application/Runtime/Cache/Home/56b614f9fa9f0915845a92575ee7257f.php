...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_14474__=($page['pages']-9);$__FOR_END_14474__=($page['pages']+1);for($i=$__FOR_START_14474__;$i < $__FOR_END_14474__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_20219__=1;$__FOR_END_20219__=11;for($i=$__FOR_START_20219__;$i < $__FOR_END_20219__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_19224__=($page['pageNumber']-4);$__FOR_END_19224__=($page['pageNumber']+5);for($i=$__FOR_START_19224__;$i < $__FOR_END_19224__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_31089__=1;$__FOR_END_31089__=$page['pages'] + 1;for($i=$__FOR_START_31089__;$i < $__FOR_END_31089__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
