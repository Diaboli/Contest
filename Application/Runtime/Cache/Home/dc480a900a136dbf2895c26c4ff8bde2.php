...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_13618__=($page['pages']-9);$__FOR_END_13618__=($page['pages']+1);for($i=$__FOR_START_13618__;$i < $__FOR_END_13618__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_4739__=1;$__FOR_END_4739__=11;for($i=$__FOR_START_4739__;$i < $__FOR_END_4739__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_31744__=($page['pageNumber']-4);$__FOR_END_31744__=($page['pageNumber']+5);for($i=$__FOR_START_31744__;$i < $__FOR_END_31744__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_31801__=1;$__FOR_END_31801__=$page['pages'] + 1;for($i=$__FOR_START_31801__;$i < $__FOR_END_31801__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
