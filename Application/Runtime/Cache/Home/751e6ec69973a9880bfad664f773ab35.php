...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_29862__=($page['pages']-9);$__FOR_END_29862__=($page['pages']+1);for($i=$__FOR_START_29862__;$i < $__FOR_END_29862__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_28391__=1;$__FOR_END_28391__=11;for($i=$__FOR_START_28391__;$i < $__FOR_END_28391__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_19092__=($page['pageNumber']-4);$__FOR_END_19092__=($page['pageNumber']+5);for($i=$__FOR_START_19092__;$i < $__FOR_END_19092__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_2365__=1;$__FOR_END_2365__=$page['pages'] + 1;for($i=$__FOR_START_2365__;$i < $__FOR_END_2365__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
