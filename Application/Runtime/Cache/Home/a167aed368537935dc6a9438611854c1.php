...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_31788__=($page['pages']-9);$__FOR_END_31788__=($page['pages']+1);for($i=$__FOR_START_31788__;$i < $__FOR_END_31788__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_30453__=1;$__FOR_END_30453__=11;for($i=$__FOR_START_30453__;$i < $__FOR_END_30453__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_31882__=($page['pageNumber']-4);$__FOR_END_31882__=($page['pageNumber']+5);for($i=$__FOR_START_31882__;$i < $__FOR_END_31882__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_17147__=1;$__FOR_END_17147__=$page['pages'] + 1;for($i=$__FOR_START_17147__;$i < $__FOR_END_17147__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
