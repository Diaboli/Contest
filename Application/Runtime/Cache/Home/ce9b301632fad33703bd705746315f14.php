...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_21647__=($page['pages']-9);$__FOR_END_21647__=($page['pages']+1);for($i=$__FOR_START_21647__;$i < $__FOR_END_21647__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_17180__=1;$__FOR_END_17180__=11;for($i=$__FOR_START_17180__;$i < $__FOR_END_17180__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_19237__=($page['pageNumber']-4);$__FOR_END_19237__=($page['pageNumber']+5);for($i=$__FOR_START_19237__;$i < $__FOR_END_19237__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_29946__=1;$__FOR_END_29946__=$page['pages'] + 1;for($i=$__FOR_START_29946__;$i < $__FOR_END_29946__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
