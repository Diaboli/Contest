...
<div class="page">
	...
	<?php if($page['pageNumber'] > ($page['pages']-5) AND $page['pages'] > 10): $__FOR_START_18524__=($page['pages']-9);$__FOR_END_18524__=($page['pages']+1);for($i=$__FOR_START_18524__;$i < $__FOR_END_18524__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
	...
	<?php elseif($page['pageNumber'] < 5 AND $page['pages'] > 10): ?>
		<?php $__FOR_START_1893__=1;$__FOR_END_1893__=11;for($i=$__FOR_START_1893__;$i < $__FOR_END_1893__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php elseif($page['pages'] > 10): ?>	
		<?php $__FOR_START_7226__=($page['pageNumber']-4);$__FOR_END_7226__=($page['pageNumber']+5);for($i=$__FOR_START_7226__;$i < $__FOR_END_7226__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
 				<?php else: ?><a class="usernum" href="<?php echo U($page['url'].'/page/'.$i);?>"><?php echo ($i); ?></a><?php endif; } ?>	
	<?php else: ?>	
		<?php $__FOR_START_24811__=1;$__FOR_END_24811__=$page['pages'] + 1;for($i=$__FOR_START_24811__;$i < $__FOR_END_24811__;$i+=1){ if($page['pageNumber'] == $i): ?><span class="current"><?php echo ($i); ?></span>
